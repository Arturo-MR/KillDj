...
<div class="tabla">
		<a href="../../../../../wamp/www/KillDJ/alta.php"></a>
	  <p>
	  <label>ID</label>
		<input name="id" type="text" id="id" size="25" maxlength="10" required pattern=".{4,}[0-9]{6}" title="Remember the ID's standard: 4 Characters, 6 Numbers"/></p>
      <p>
      <label>Band/Artist</label>
		<input name="band" type="text" id="band" size="25" maxlength="100"></p>
	  <p>
